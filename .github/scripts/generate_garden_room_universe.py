...
from atlas_common import (  # noqa: F401  — extracted verbatim, see atlas_common.py
    BASE_ID, T_PRODUCTS, T_PRICING, T_AVAIL, T_FEATVALS, T_FEATURES, T_ORGS,
    API, PAGE_SIZE, RETRIES,
    IE_CONFIRMED, IE_UNAVAILABLE, IE_UNKNOWN, IE_NO_PUBLISHED_ROUTE,
    INTERNAL_LEAD_PHRASES,
    redact, fail, fetch_all, cell, links, txt, homeowner_text,
    classify_irish_availability,
)

# ── Atlas addressing ─────────────────────────────────────────────────────────
# The base id is an identifier, not a credential: useless without a token.
# BASE_ID — moved to atlas_common.py (Gate S1 extraction).

# T_PRODUCTS — moved to atlas_common.py (Gate S1 extraction).
# T_PRICING — moved to atlas_common.py (Gate S1 extraction).
# T_AVAIL — moved to atlas_common.py (Gate S1 extraction).
# T_FEATVALS — moved to atlas_common.py (Gate S1 extraction).
# T_FEATURES — moved to atlas_common.py (Gate S1 extraction).
# T_ORGS — moved to atlas_common.py (Gate S1 extraction).
...
# RETRIES — moved to atlas_common.py (Gate S1 extraction).
...
# IE_CONFIRMED — moved to atlas_common.py (Gate S1 extraction).
# IE_UNAVAILABLE — moved to atlas_common.py (Gate S1 extraction).
# IE_UNKNOWN — moved to atlas_common.py (Gate S1 extraction).
...
# IE_NO_PUBLISHED_ROUTE — moved to atlas_common.py (Gate S1 extraction).
...
# INTERNAL_LEAD_PHRASES — moved to atlas_common.py (Gate S1 extraction).
# _REC_ID_RE — moved to atlas_common.py (Gate S1 extraction).


# redact — moved to atlas_common.py (Gate S1 extraction).


# fail — moved to atlas_common.py (Gate S1 extraction).


# ── Airtable, read-only ──────────────────────────────────────────────────────
# fetch_all — moved to atlas_common.py (Gate S1 extraction).


# cell — moved to atlas_common.py (Gate S1 extraction).


# links — moved to atlas_common.py (Gate S1 extraction).


# txt — moved to atlas_common.py (Gate S1 extraction).


# homeowner_text — moved to atlas_common.py (Gate S1 extraction).
...
# ── qualification ────────────────────────────────────────────────────────────
# classify_irish_availability — moved to atlas_common.py (Gate S1 extraction).
